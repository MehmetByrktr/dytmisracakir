...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  <div className="relative mt-8 aspect-[16/9] overflow-hidden rounded-xl2 bg-sage-50">{post.coverImage ? <Image src={post.coverImage} alt={post.title} fill sizes="(max-width: 768px) 100vw, 768px" className="object-cover" /> : <div className="flex h-full items-center justify-center font-mono text-xs uppercase tracking-wide text-sage-600">Kapak görseli</div>}</div>
