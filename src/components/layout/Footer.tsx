...
export default function Footer({ siteData = defaultSite }: { siteData?: typeof defaultSite }) {
  const site = siteData;
  return (
    <footer className="relative overflow-hidden border-t border-cream/10 bg-ink text-cream [&_.eyebrow]:text-sage-300">
      <div className="container-site grid gap-12 py-16 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="mt-6 flex gap-3">
            {[
              ...
              <a
                ...
                aria-label={label}
                className="flex h-9 w-9 items-center justify-center rounded-full border border-cream/20 text-cream/70 transition-colors hover:border-clay-soft hover:text-clay-soft"
              >
        ...
        <div>
          ...
          <ul className="space-y-3">
            {footerLinks.quick.map((l) => (
              <li key={l.href}>
                <Link href={l.href} className="text-sm text-cream/70 transition-colors hover:text-clay-soft">
                  {l.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-cream/70">
            ...
            <li className="flex items-start gap-2">
              <Mail className="mt-0.5 h-4 w-4 shrink-0 text-sage-300" />
      ...
      <div className="border-t border-cream/10 py-6">
        <p className="container-site text-center text-xs text-cream/55">
